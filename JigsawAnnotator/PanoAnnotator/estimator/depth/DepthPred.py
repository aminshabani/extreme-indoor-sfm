...
MODEL_FILE = 'PanoAnnotator/estimator/depth/models/trained/NYU_ResNet-UpProj_pano_512_20_epoch.ckpt'
...
class DepthPred(object):
    def __init__(self, parent=None):
        ...
        self.net = ResNet50UpProj({'data': self.input_node}, BATCH_SIZE, 1,
                                  False)
    ...
    def predict(self, image):
        ...
        pred = self.sess.run(self.net.get_output(),
                             feed_dict={self.input_node: input_data})
        #print(pred.shape)
